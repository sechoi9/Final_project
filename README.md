...
### *** ran into some issues with trinity (no storage space on cluster)
...
## Prepare files
### Trim reads using trimmomatic (was able to do this on cluster)
...
1. Need to change file name for each one before running
